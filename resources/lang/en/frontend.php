...
if (isset($language_frontend_one_group_keyword) && isset($language_frontend_two_group_keyword)) {
    ...
    return [
      ...
      */
        ...
        $frontend_one_group_columns[16] => $language_frontend_one_group_keyword->read_more,
        $frontend_one_group_columns[17] => $language_frontend_one_group_keyword->call_us_now,
        $frontend_one_group_columns[18] => $language_frontend_one_group_keyword->more_question,
        ...
        $frontend_two_group_columns[14] => $language_frontend_two_group_keyword->view_more,
